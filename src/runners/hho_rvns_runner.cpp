...
static void run_rvns_from_hho(hscopt_hho_ctx *hho, size_t n_keys,
  ...
  hscopt_rvns_ctx *rvns = hscopt_rvns_create(
      n_keys, params.rvns_k_max, params.rvns_iterations, params.max_threads,
      decoder_fn, dctx, &rvns_rng, hscopt_hho_best_keys(hho));
  if (rvns == nullptr) {
...
int main(int argc, char *argv[]) {
  ...
  app.add_option("--ls-int,--local-search-interval",
                 params.local_search_interval, "Intervalo da busca local RVNS");
